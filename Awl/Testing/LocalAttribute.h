...
#define AWT_ATTRIBUTE(attribute_type, attribute_name, default_val) const attribute_type attribute_name = std::move(awl::testing::LocalAttribute<attribute_type>(context.ap, _T(#attribute_type), _T(#attribute_name), default_val).GetValue())
