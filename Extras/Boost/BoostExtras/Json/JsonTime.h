...
namespace awl::boost_json
{
    ...
    private:
        ...
        static std::string toExtendedFormat(common_duration v)
        {
        ...
        static common_duration parseExtendedFormat(std::string_view input, const std::string& original_text)
        {
        ...
        static void throwWrongDurationValue(const std::string& text, const awl::String& details)
        {
