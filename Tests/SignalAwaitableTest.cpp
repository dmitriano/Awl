...
AWL_TEST(SignalAwaitable_SingleArgument)
{
    ...
    awl::coro::Job job = awl::coro::coSpawn(waitInt(signal.signal(), result));
...
AWL_TEST(SignalAwaitable_MoveConstructedBeforeAwait)
{
    ...
    awl::coro::Job job = awl::coro::coSpawn(waitMovedInt(signal.signal(), result));
...
AWL_TEST(SignalAwaitable_Tuple)
{
    ...
    awl::coro::Job job = awl::coro::coSpawn(waitTuple(signal.signal(), sender, value));
...
AWL_TEST(SignalAwaitable_Void)
{
    ...
    awl::coro::Job job = awl::coro::coSpawn(waitVoid(signal.signal(), resumed));
...
AWL_TEST(SignalAccumulator_QueuesBeforeWait)
{
    ...
    int result = 0;
    awl::coro::Job job = awl::coro::coSpawn(waitAccumulatedInt(accumulator, result));
...
AWL_TEST(SignalAccumulator_QueuesInOrder)
{
    ...
    std::vector<int> values;
    awl::coro::Job job = awl::coro::coSpawn(waitAccumulatedInts(accumulator, values));
...
AWL_TEST(SignalAccumulator_QueuesDuringProcessing)
{
    ...
    awl::coro::Job job = awl::coro::coSpawn(emitDuringAccumulatedProcessing(accumulator, signal, values));
...
AWL_TEST(SignalAccumulator_Void)
{
    ...
    awl::coro::Job job = awl::coro::coSpawn(waitAccumulatedVoid(accumulator, count));
...
AWL_TEST(SignalRangeAccumulator_Value)
{
    ...
    awl::coro::Job job = awl::coro::coSpawn(waitRangeValue(objects, sender, value));
...
AWL_TEST(SignalRangeAccumulator_MemberFunction)
{
    ...
    awl::coro::Job job = awl::coro::coSpawn(waitRangeMethodValue(objects, sender, value));
...
AWL_TEST(SignalRangeAccumulator_Void)
{
    ...
    awl::coro::Job job = awl::coro::coSpawn(waitRangeVoid(objects, sender));
...
AWL_TEST(SignalRangeAccumulator_FilterView)
{
    ...
    awl::coro::Job job = awl::coro::coSpawn(waitRangeValue(enabled_objects, sender, value));
...
AWL_TEST(SignalRangeAccumulator_QueuesBeforeWait)
{
    ...
    awl::coro::Job job = awl::coro::coSpawn(waitAccumulatedValue(accumulator, sender, value));
...
AWL_TEST(SignalRangeAccumulator_WaitMany)
{
    ...
    awl::coro::Job job = awl::coro::coSpawn(waitAccumulatedValues(accumulator, senders, values));
