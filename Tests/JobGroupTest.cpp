...
namespace
{
    ...
    {
        jobs.spawn(awl::coro::coSpawn(nullptr, delayedJob(context, time_queue, 1)));
        jobs.spawn(awl::coro::coSpawn(nullptr, delayedJob(context, time_queue, 2)));
        jobs.spawn(awl::coro::coSpawn(nullptr, delayedJob(context, time_queue, 3)));
...
AWL_TEST(JobGroupWaitAllJobsDirectly)
{
    ...
    awl::coro::Job task = awl::coro::coSpawn(nullptr,
        awl::coro::JobGroupTestAccess::waitAllJobs(context, time_queue, jobs));
...
AWL_TEST(JobGroupWaitAnyThenWaitAll)
{
    ...
    awl::coro::Job task = awl::coro::coSpawn(nullptr,
        awl::coro::JobGroupTestAccess::waitAnyThenWaitAll(context, time_queue, jobs));
...
AWL_TEST(JobGroupCancelBeforeWaiting)
{
    ...
    awl::coro::Job task = awl::coro::coSpawn(nullptr,
        awl::coro::JobGroupTestAccess::waitAnyThenWaitAll(context, time_queue, jobs, wait_jobs_directly, 0));
...
AWL_TEST(JobGroupCancelAfterFirstJobFinished)
{
    ...
    awl::coro::Job task = awl::coro::coSpawn(nullptr,
        awl::coro::JobGroupTestAccess::waitAnyThenWaitAll(context, time_queue, jobs, wait_jobs_directly));
