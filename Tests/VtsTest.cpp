...
AWT_TEST(VtsArray)
{
    ...
    DataWithArray1 d1 = { { v1::b_expected, v1::b_expected }, {1, 2} };
...

    {
        ...
        AWT_ASSERT(d2.a1[0] == d1.a1[0] && d2.a1[1] == d1.a1[1] && d2.a1[2] == v1::B{});

        AWT_ASSERT(d2.a2[0] == d1.a2[0] && d2.a2[1] == d1.a2[1] && d2.a2[2] == 0);
    }
}
